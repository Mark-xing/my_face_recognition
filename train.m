file_path='F:\\模式识别项目\\文件\\muct人脸数据库_项目\\已知类别\\';% 图像文件夹路径 
...
% 读取每一幅图像
%转化为灰度图像 并将每一幅图像转化为列向量 然后合并为矩阵Ts
...
save('F:\模式识别项目\自写\代码\TrainProjectedImages.mat','TrainProjectedImages');
save('F:\模式识别项目\自写\代码\Eigenfaces.mat','Eigenfaces');
